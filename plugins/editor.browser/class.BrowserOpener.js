...
Class.create("BrowserOpener", AbstractEditor, {
	...
	open : function($super, userSelection){
        ...
        var extra_component = open_file_url.substring(open_file_url.indexOf('?'), open_file_url.lastIndexOf('?'));
        if(extra_component != '') {
          open_file_url = open_file_url.replace(extra_component, 'index.php');
        }
