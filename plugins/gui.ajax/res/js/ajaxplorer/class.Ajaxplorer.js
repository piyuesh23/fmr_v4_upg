...
Class.create("Ajaxplorer", {
	...
	loadXmlRegistry : function(sync, xPath){
      ...
      var repositoryId = ajaxplorer.repositoryId;
      var repo_label = ajaxplorer.user.repositories.get(repositoryId).label;
/*---customization to populate header and footer with repository specific details on repo switch---*/
