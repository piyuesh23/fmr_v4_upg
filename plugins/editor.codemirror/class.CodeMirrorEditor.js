...
/*--overriding the save action for source editor--backing up the file before saving it.--*/
        this.makeDir_backup();
        this.copyFile();
	...
	prepareSaveConnexion : function(){
      ...
      if(responseText == "The file has been saved successfully")
...
/*--create backup dir if it doesn't exist--*/
  preparemakeDir_backupConnexion : function(dir, fname){
    ...
    if(!dir)
      dir = this.userSelection.getCurrentRep();

		connexion.addParameter('dir', dir);
...
/*--Copy the file in the backup dir and then trigger save action--*/
...
/*--Create the logfile if it doesn't exist and then write to the logfile--*/
